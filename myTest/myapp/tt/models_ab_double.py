...
class AbTestTable(models.Model):
    ...
    m4 = models.TextField(blank=True, null=True)  # This field type is a guess.
    m5 = models.TextField(blank=True, null=True)  # This field type is a guess.
    m6 = models.TextField(blank=True, null=True)  # This field type is a guess.
    m7 = models.TextField(blank=True, null=True)  # This field type is a guess.
